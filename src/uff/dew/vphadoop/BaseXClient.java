...
public class BaseXClient {
  ...
  public void executeXQuery(final String xpath, final OutputStream o) throws IOException {
	  execute("xquery " + xpath, o);
  }
  
  public String executeXQuery(final String xquery) throws IOException {
	  final ByteArrayOutputStream os = new ByteArrayOutputStream();
	  execute("xquery " + xquery, os);
	  return new String(os.toByteArray(), UTF8);
  }
